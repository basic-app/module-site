...
$routes->add('admin/menu-item', 'BasicApp\Site\Controllers\Admin\MenuItem::index');
$routes->add('admin/menu-item/(:segment)', 'BasicApp\Site\Controllers\Admin\MenuItem::$1');
